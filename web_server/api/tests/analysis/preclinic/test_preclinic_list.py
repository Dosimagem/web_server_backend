...
def test_read_preclinic_dosimetry(client_api_auth, preclinic_dosimetry):
    '''
    ...
    url = resolve_url('api:analysis-read-update-delete', user.uuid, order.uuid, preclinic_dosimetry.uuid)
    resp = client_api_auth.get(url)
