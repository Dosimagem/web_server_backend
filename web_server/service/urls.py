...
urlpatterns = [
    ...
    path(
        'users/<uuid:user_id>/orders/<uuid:order_id>',
        orders_read,
        name='order-read',
    ),
    #
    ...
    #
    path(
        'users/<uuid:user_id>/calibrations/',
        calibrations_list_create,
        name='calibration-list-create',
    ),
    path(
    ...
    #
    path(
        'users/<uuid:user_id>/orders/<uuid:order_id>/analysis/',
        analysis_list_create,
