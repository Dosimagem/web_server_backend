...
from web_server.service.models import FORMAT_DATE, Order, PreClinicDosimetryAnalysis
...
def test_error_message_only_status_invalid_info(client_api_auth, preclinic_dosimetry):
    ...
    preclinic_dosimetry.status = PreClinicDosimetryAnalysis.Status.INVALID_INFOS
    preclinic_dosimetry.save()
