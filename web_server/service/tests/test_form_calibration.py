...
def test_valid_create_form_calibration(calibration_infos):

    form = CreateCalibrationForm(data=calibration_infos)
...
def test_invalid_create_form_field_must_be_positive(calibration_infos, field):
...
def test_invalid_missing_fields(calibration_infos, field):

    calibration_infos.pop(field)
...
def test_invalid_isotope(calibration_infos):
...
def test_valid_create_form_field_save(calibration_infos):
