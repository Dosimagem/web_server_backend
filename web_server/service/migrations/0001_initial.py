    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(default=0, verbose_name='Amount of analysis'),
                ),
                (
                    'remaining_of_analyzes',
                    models.PositiveIntegerField(default=0, verbose_name='Remaning of analysis'),
                ),
                (
                    'price',
                    models.DecimalField(decimal_places=2, max_digits=14, verbose_name='Price'),
                ),
                (
                    'status_payment',
                    models.CharField(
                        choices=[
                            ('APG', 'Aguardando pagamento'),
                            ('CON', 'Confirmado'),
                        ],
                        default='APG',
                        max_length=3,
                ...
                (
                    'permission',
                    models.BooleanField(default=False, verbose_name='Permission'),
                ),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'calibration_name',
                    models.CharField(max_length=24, verbose_name='Calibration Name'),
                ),
                (
                    'syringe_activity',
                    models.FloatField(
                        validators=[django.core.validators.MinValueValidator(0.0)],
                        verbose_name='Syringe Activity',
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateTimeField(verbose_name='Measurement Datetime'),
                ),
                (
                    'phantom_volume',
                    models.FloatField(
                        validators=[django.core.validators.MinValueValidator(0.0)],
                        verbose_name='Phantom Volume',
                    ),
                ),
                (
                    'acquisition_time',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'analysis_name',
                    models.CharField(max_length=24, verbose_name='Analysis Name'),
                ),
                (
                    'status',
                    models.CharField(
                        choices=[
                            ('AP', 'Verificando informações'),
                            ('EA', 'Informações inválidas'),
                ...
                (
                    ...
                    models.FloatField(
                        validators=[django.core.validators.MinValueValidator(0.0)],
                        verbose_name='Injected Activity',
                    ),
                ),
                (
                    'administration_datetime',
                    models.DateTimeField(verbose_name='Administration Datetime'),
                ),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                (
